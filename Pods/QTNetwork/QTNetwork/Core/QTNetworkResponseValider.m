...
NSString * const QTNetworkResponseValiderErrorDomain = @"com.qtnetwork.response.valider";

@interface QTJSONSchemaValider()
...
@implementation QTJSONSchemaValider

+ (instancetype)arrayValiderWithScheme:(NSArray *)scheme{
    QTJSONSchemaValider * valider = [[QTJSONSchemaValider alloc] init];
        ...
        while ((key = [enumerator nextObject]) != nil) {
            ...
            if ([value isKindOfClass:[NSDictionary class]]
                ...
                if ([value isKindOfClass:format] == NO &&
                    ...
                    NSError * validerError = [NSError errorWithDomain:QTNetworkResponseValiderErrorDomain
                                                          code:-1
                                                      userInfo:userInfo];
                    *error = validerError;
                    result = NO;
